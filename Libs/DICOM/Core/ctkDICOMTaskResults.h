...
public:
  ...
  /// DCM dataset
  Q_INVOKABLE void setDataset(DcmItem* dataset, bool takeOwnership = true);
  ...
  Q_INVOKABLE void setDatasetsMap(QMap<QString, DcmItem *> datasetsMap, bool takeOwnership = true);
