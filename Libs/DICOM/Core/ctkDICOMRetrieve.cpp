...
public:
  ...
  virtual OFCondition handleSTORERequest(const T_ASC_PresentationContextID presID,
                                         ...
                                         Uint16& cStoreReturnStatus)
    {
      ...
      emit this->retrieve->progress(0);
      if (!this->retrieve->taskUID().isEmpty() && !this->retrieve->wasCanceled())
        {
        ...
        if (this->retrieve->getLastRetrieveType() == ctkDICOMRetrieve::RetrieveType::RetrieveSOPInstance)
          {
          taskResults->setTypeOfTask(ctkDICOMTaskResults::TaskType::RetrieveSOPInstance);
          }
        else if (this->retrieve->getLastRetrieveType() == ctkDICOMRetrieve::RetrieveType::RetrieveSeries)
          {
          taskResults->setTypeOfTask(ctkDICOMTaskResults::TaskType::RetrieveSeries);
          }
        else if (this->retrieve->getLastRetrieveType() == ctkDICOMRetrieve::RetrieveType::RetrieveStudy)
          {
          taskResults->setTypeOfTask(ctkDICOMTaskResults::TaskType::RetrieveStudy);
          }
        taskResults->setStudyInstanceUID(this->retrieve->studyInstanceUID());
        taskResults->setSeriesInstanceUID(this->retrieve->seriesInstanceUID());
        taskResults->setSOPInstanceUID(qInstanceUID);
        taskResults->setConnectionName(this->retrieve->connectionName());
        taskResults->setDataset(incomingObject);

        taskResults->setTaskUID(this->retrieve->taskUID());
        taskResults->setCopyFile(true);

        if (this->retrieve->getLastRetrieveType() == ctkDICOMRetrieve::RetrieveType::RetrieveSeries)
          {
          emit this->retrieve->progressTaskDetail(taskResults.data());
          }
...
public:
  ...
  QList<QSharedPointer<ctkDICOMTaskResults>> TaskResultsList;
                                   ...
                                   const ctkDICOMRetrieve::RetrieveType retrieveType)
{
  ...
  if (!this->initializeSCU(studyInstanceUID, seriesInstanceUID, SOPInstanceUID, retrieveType, retrieveParameters))
    {
  ...
  taskResults->setStudyInstanceUID(q->studyInstanceUID());
  taskResults->setSeriesInstanceUID(q->seriesInstanceUID());
  taskResults->setConnectionName(q->connectionName());
  taskResults->setTaskUID(q->taskUID());
  q->addTaskResults(taskResults);
...
//------------------------------------------------------------------------------
QList<QSharedPointer<ctkDICOMTaskResults>> ctkDICOMRetrieve::taskResultsList() const
{
  Q_D(const ctkDICOMRetrieve);
  return d->TaskResultsList;
}

//------------------------------------------------------------------------------
void ctkDICOMRetrieve::addTaskResults(QSharedPointer<ctkDICOMTaskResults> results)
{
  Q_D(ctkDICOMRetrieve);
  d->TaskResultsList.append(results);
}

//------------------------------------------------------------------------------
void ctkDICOMRetrieve::setTaskUID(const QString &taskUID)
{
  Q_D(ctkDICOMRetrieve);
  d->TaskUID = taskUID;
}
...
//------------------------------------------------------------------------------
QString ctkDICOMRetrieve::taskUID() const
{
  Q_D(const ctkDICOMRetrieve);
  return d->TaskUID;
}
...
//-----------------------------------------------------------------------------
int ctkDICOMRetrieve::connectionTimeout()
{
  Q_D(const ctkDICOMRetrieve);
...
bool ctkDICOMRetrieve::moveStudy(const QString& studyInstanceUID)
{
  ...
  return d->move(studyInstanceUID, "", "", ctkDICOMRetrieve::RetrieveStudy);
}
...
bool ctkDICOMRetrieve::getStudy(const QString& studyInstanceUID)
{
  ...
  return d->get(studyInstanceUID, "", "", ctkDICOMRetrieve::RetrieveStudy);
}
                                  ...
                                  const QString& seriesInstanceUID)
{
  ...
  return d->move(studyInstanceUID, seriesInstanceUID, "", ctkDICOMRetrieve::RetrieveSeries);
}
                                 ...
                                 const QString& seriesInstanceUID)
{
  ...
  return d->get(studyInstanceUID, seriesInstanceUID, "", ctkDICOMRetrieve::RetrieveSeries);
}
                                       ...
                                       const QString &SOPInstanceUID)
{
  if (studyInstanceUID.isEmpty() ||
    ...
    {
    logger.error("Cannot receive SOPInstance: Either Study, Series or SOP Instance UID empty.");
    return false;
    }
  Q_D(ctkDICOMRetrieve);
  logger.debug("Starting moveSOPInstance");
  return d->move(studyInstanceUID, seriesInstanceUID, SOPInstanceUID, ctkDICOMRetrieve::RetrieveSOPInstance);
}
                                      ...
                                      const QString &SOPInstanceUID)
{
  ...
  return d->get(studyInstanceUID, seriesInstanceUID, SOPInstanceUID, ctkDICOMRetrieve::RetrieveSOPInstance);
}
