...
public:
  ...
  ctkDICOMServer* createServerFromServerNode(const QMap<QString, QVariant>& node);
...
int ctkDICOMServerNodeWidget2Private::addServerNode(ctkDICOMServer *server)
{
  ...
  newItem = new QTableWidgetItem(QString::number(server->port()));
  this->NodeTable->setItem(rowCount, ctkDICOMServerNodeWidget2::PortColumn, newItem);
  ...
  newItem = new QTableWidgetItem(QString::number(server->connectionTimeout()));
  this->NodeTable->setItem(rowCount, ctkDICOMServerNodeWidget2::TimeoutColumn, newItem);
...
//----------------------------------------------------------------------------
ctkDICOMServer* ctkDICOMServerNodeWidget2Private::createServerFromServerNode(const QMap<QString, QVariant> &node)
{
...
//----------------------------------------------------------------------------
int ctkDICOMServerNodeWidget2::addServerNode()
{
  Q_D(ctkDICOMServerNodeWidget2);
  const int rowCount = d->NodeTable->rowCount();
  d->NodeTable->setRowCount(rowCount + 1);

  QTableWidgetItem *newItem = new QTableWidgetItem(QString::number(rowCount));
  ...
  protocolComboBox->addItem("CMOVE");
  // To Do: protocolComboBox->addItem("WADO");
  connect(protocolComboBox, SIGNAL(currentIndexChanged(int)),
          this, SLOT(onSettingsModified()));
  d->NodeTable->setItem(rowCount, ProtocolColumn, newItem);
  d->NodeTable->setCellWidget(rowCount, ProtocolColumn, protocolComboBox);
...
//----------------------------------------------------------------------------
void ctkDICOMServerNodeWidget2::removeCurrentServerNode()
{
  Q_D(ctkDICOMServerNodeWidget2);
...
//----------------------------------------------------------------------------
void ctkDICOMServerNodeWidget2::testCurrentServerNode()
{
  Q_D(ctkDICOMServerNodeWidget2);
...
void ctkDICOMServerNodeWidget2::saveSettings()
{
  ...
  for (int row = 0; row < rowCount; ++row)
    ...
    ctkDICOMServer* server = d->createServerFromServerNode(node);
    d->TaskPool->addServer(server);
    }
  ...
  for (int ii = 0; ii < rowCount; ++ii)
    ...
    ctkDICOMServer* proxyServer = d->createServerFromServerNode(node);
...
//----------------------------------------------------------------------------
void ctkDICOMServerNodeWidget2::setStorageAETitle(QString storageAETitle)
{
...
//----------------------------------------------------------------------------
ctkDICOMTaskPool* ctkDICOMServerNodeWidget2::taskPool()const
{
  Q_D(const ctkDICOMServerNodeWidget2);
...
//----------------------------------------------------------------------------
QSharedPointer<ctkDICOMTaskPool> ctkDICOMServerNodeWidget2::taskPoolShared()const
{
  Q_D(const ctkDICOMServerNodeWidget2);
  return d->TaskPool;
}
...
//----------------------------------------------------------------------------
void ctkDICOMServerNodeWidget2::setTaskPool(ctkDICOMTaskPool& taskPool)
{
  Q_D(ctkDICOMServerNodeWidget2);
...
//----------------------------------------------------------------------------
void ctkDICOMServerNodeWidget2::setTaskPool(QSharedPointer<ctkDICOMTaskPool> taskPool)
{
  Q_D(ctkDICOMServerNodeWidget2);
  d->TaskPool = taskPool;
}
...
ctkDICOMServer* ctkDICOMServerNodeWidget2::getServer(const char *connectionName)
{
  ...
  return d->TaskPool->getServer(connectionName);
}
...
int ctkDICOMServerNodeWidget2::getServerIndexFromName(const char *connectionName)
{
  ...
  return d->TaskPool->getServerIndexFromName(connectionName);
}
